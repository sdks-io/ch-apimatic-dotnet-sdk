...
public sealed class BackupBucketDeleteError : ApiError
{
    ...
    private BackupBucketDeleteError(Optional<V1OrganizationsServicesBackupBucket400Error1> v1OrganizationsServicesBackupBucket400Error1Value,
    ...
    private static BackupBucketDeleteError AsV1OrganizationsServicesBackupBucket400Error1(V1OrganizationsServicesBackupBucket400Error1 value) =>
        new(Optional<V1OrganizationsServicesBackupBucket400Error1>.Some(value), default, default);

    private static BackupBucketDeleteError AsV1OrganizationsServicesBackupBucket500Error1(V1OrganizationsServicesBackupBucket500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesBackupBucket500Error1>.Some(value), default);

    private static BackupBucketDeleteError AsFallback(RawError value) =>
    ...
    internal static Task<BackupBucketDeleteError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class BackupBucketDeleteErrorResponse : IErrorResponse<BackupBucketDeleteError>
{
    public static BackupBucketDeleteErrorResponse Instance { get; } = new();

    private BackupBucketDeleteErrorResponse()
    {
    }

    public Task<BackupBucketDeleteError> Map(HttpResponseMessage response, CancellationToken ct) =>
        BackupBucketDeleteError.Create(response, ct);
}
