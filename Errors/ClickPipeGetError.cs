...
public sealed class ClickPipeGetError : ApiError
{
    ...
    private ClickPipeGetError(Optional<V1OrganizationsServicesClickpipesClickPipeId400Error1> v1OrganizationsServicesClickpipesClickPipeId400Error1Value,
    ...
    private static ClickPipeGetError AsV1OrganizationsServicesClickpipesClickPipeId400Error1(V1OrganizationsServicesClickpipesClickPipeId400Error1 value) =>
        new(Optional<V1OrganizationsServicesClickpipesClickPipeId400Error1>.Some(value), default, default);

    private static ClickPipeGetError AsV1OrganizationsServicesClickpipesClickPipeId500Error1(V1OrganizationsServicesClickpipesClickPipeId500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesClickpipesClickPipeId500Error1>.Some(value), default);

    private static ClickPipeGetError AsFallback(RawError value) =>
    ...
    internal static Task<ClickPipeGetError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class ClickPipeGetErrorResponse : IErrorResponse<ClickPipeGetError>
{
    public static ClickPipeGetErrorResponse Instance { get; } = new();

    private ClickPipeGetErrorResponse()
    {
    }

    public Task<ClickPipeGetError> Map(HttpResponseMessage response, CancellationToken ct) =>
        ClickPipeGetError.Create(response, ct);
}
