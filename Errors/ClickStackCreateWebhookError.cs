...
public sealed class ClickStackCreateWebhookError : ApiError
{
    ...
    private ClickStackCreateWebhookError(Optional<V1OrganizationsServicesClickstackWebhooks400Error1> v1OrganizationsServicesClickstackWebhooks400Error1Value,
    ...
    private static ClickStackCreateWebhookError AsV1OrganizationsServicesClickstackWebhooks400Error1(V1OrganizationsServicesClickstackWebhooks400Error1 value) =>
        new(Optional<V1OrganizationsServicesClickstackWebhooks400Error1>.Some(value), default, default);

    private static ClickStackCreateWebhookError AsV1OrganizationsServicesClickstackWebhooks500Error1(V1OrganizationsServicesClickstackWebhooks500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesClickstackWebhooks500Error1>.Some(value), default);

    private static ClickStackCreateWebhookError AsFallback(RawError value) =>
    ...
    internal static Task<ClickStackCreateWebhookError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class ClickStackCreateWebhookErrorResponse : IErrorResponse<ClickStackCreateWebhookError>
{
    public static ClickStackCreateWebhookErrorResponse Instance { get; } = new();

    private ClickStackCreateWebhookErrorResponse()
    {
    }

    public Task<ClickStackCreateWebhookError> Map(HttpResponseMessage response, CancellationToken ct) =>
        ClickStackCreateWebhookError.Create(response, ct);
}
