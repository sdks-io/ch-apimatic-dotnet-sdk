...
public sealed class ClickStackDeleteRoleError : ApiError
{
    ...
    private ClickStackDeleteRoleError(Optional<V1OrganizationsServicesClickstackRolesClickStackRoleId400Error1> v1OrganizationsServicesClickstackRolesClickStackRoleId400Error1Value,
    ...
    private static ClickStackDeleteRoleError AsV1OrganizationsServicesClickstackRolesClickStackRoleId400Error1(V1OrganizationsServicesClickstackRolesClickStackRoleId400Error1 value) =>
        new(Optional<V1OrganizationsServicesClickstackRolesClickStackRoleId400Error1>.Some(value), default, default);

    private static ClickStackDeleteRoleError AsV1OrganizationsServicesClickstackRolesClickStackRoleId500Error1(V1OrganizationsServicesClickstackRolesClickStackRoleId500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesClickstackRolesClickStackRoleId500Error1>.Some(value), default);

    private static ClickStackDeleteRoleError AsFallback(RawError value) =>
    ...
    internal static Task<ClickStackDeleteRoleError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class ClickStackDeleteRoleErrorResponse : IErrorResponse<ClickStackDeleteRoleError>
{
    public static ClickStackDeleteRoleErrorResponse Instance { get; } = new();

    private ClickStackDeleteRoleErrorResponse()
    {
    }

    public Task<ClickStackDeleteRoleError> Map(HttpResponseMessage response, CancellationToken ct) =>
        ClickStackDeleteRoleError.Create(response, ct);
}
