...
public sealed class ClickStackDeleteSourceError : ApiError
{
    ...
    private ClickStackDeleteSourceError(Optional<V1OrganizationsServicesClickstackSourcesClickStackSourceId400Error1> v1OrganizationsServicesClickstackSourcesClickStackSourceId400Error1Value,
    ...
    private static ClickStackDeleteSourceError AsV1OrganizationsServicesClickstackSourcesClickStackSourceId400Error1(V1OrganizationsServicesClickstackSourcesClickStackSourceId400Error1 value) =>
        new(Optional<V1OrganizationsServicesClickstackSourcesClickStackSourceId400Error1>.Some(value), default, default);

    private static ClickStackDeleteSourceError AsV1OrganizationsServicesClickstackSourcesClickStackSourceId500Error1(V1OrganizationsServicesClickstackSourcesClickStackSourceId500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesClickstackSourcesClickStackSourceId500Error1>.Some(value), default);

    private static ClickStackDeleteSourceError AsFallback(RawError value) =>
    ...
    internal static Task<ClickStackDeleteSourceError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class ClickStackDeleteSourceErrorResponse : IErrorResponse<ClickStackDeleteSourceError>
{
    public static ClickStackDeleteSourceErrorResponse Instance { get; } = new();

    private ClickStackDeleteSourceErrorResponse()
    {
    }

    public Task<ClickStackDeleteSourceError> Map(HttpResponseMessage response, CancellationToken ct) =>
        ClickStackDeleteSourceError.Create(response, ct);
}
