...
public sealed class ClickStackUpdateRoleError : ApiError
{
    ...
    private ClickStackUpdateRoleError(Optional<V1OrganizationsServicesClickstackRolesClickStackRoleId400Error1> v1OrganizationsServicesClickstackRolesClickStackRoleId400Error1Value,
    ...
    private static ClickStackUpdateRoleError AsV1OrganizationsServicesClickstackRolesClickStackRoleId400Error1(V1OrganizationsServicesClickstackRolesClickStackRoleId400Error1 value) =>
        new(Optional<V1OrganizationsServicesClickstackRolesClickStackRoleId400Error1>.Some(value), default, default);

    private static ClickStackUpdateRoleError AsV1OrganizationsServicesClickstackRolesClickStackRoleId500Error1(V1OrganizationsServicesClickstackRolesClickStackRoleId500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesClickstackRolesClickStackRoleId500Error1>.Some(value), default);

    private static ClickStackUpdateRoleError AsFallback(RawError value) =>
    ...
    internal static Task<ClickStackUpdateRoleError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class ClickStackUpdateRoleErrorResponse : IErrorResponse<ClickStackUpdateRoleError>
{
    public static ClickStackUpdateRoleErrorResponse Instance { get; } = new();

    private ClickStackUpdateRoleErrorResponse()
    {
    }

    public Task<ClickStackUpdateRoleError> Map(HttpResponseMessage response, CancellationToken ct) =>
        ClickStackUpdateRoleError.Create(response, ct);
}
