...
public sealed class InstanceQueryEndpointGetError : ApiError
{
    ...
    private InstanceQueryEndpointGetError(Optional<V1OrganizationsServicesServiceQueryEndpoint400Error1> v1OrganizationsServicesServiceQueryEndpoint400Error1Value,
    ...
    private static InstanceQueryEndpointGetError AsV1OrganizationsServicesServiceQueryEndpoint400Error1(V1OrganizationsServicesServiceQueryEndpoint400Error1 value) =>
        new(Optional<V1OrganizationsServicesServiceQueryEndpoint400Error1>.Some(value), default, default);

    private static InstanceQueryEndpointGetError AsV1OrganizationsServicesServiceQueryEndpoint500Error1(V1OrganizationsServicesServiceQueryEndpoint500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesServiceQueryEndpoint500Error1>.Some(value), default);

    private static InstanceQueryEndpointGetError AsFallback(RawError value) =>
    ...
    internal static Task<InstanceQueryEndpointGetError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class InstanceQueryEndpointGetErrorResponse : IErrorResponse<InstanceQueryEndpointGetError>
{
    public static InstanceQueryEndpointGetErrorResponse Instance { get; } = new();

    private InstanceQueryEndpointGetErrorResponse()
    {
    }

    public Task<InstanceQueryEndpointGetError> Map(HttpResponseMessage response, CancellationToken ct) =>
        InstanceQueryEndpointGetError.Create(response, ct);
}
