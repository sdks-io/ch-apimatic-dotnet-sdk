...
public sealed class InstanceQueryEndpointUpsertError : ApiError
{
    ...
    private InstanceQueryEndpointUpsertError(Optional<V1OrganizationsServicesServiceQueryEndpoint400Error1> v1OrganizationsServicesServiceQueryEndpoint400Error1Value,
    ...
    private static InstanceQueryEndpointUpsertError AsV1OrganizationsServicesServiceQueryEndpoint400Error1(V1OrganizationsServicesServiceQueryEndpoint400Error1 value) =>
        new(Optional<V1OrganizationsServicesServiceQueryEndpoint400Error1>.Some(value), default, default);

    private static InstanceQueryEndpointUpsertError AsV1OrganizationsServicesServiceQueryEndpoint500Error1(V1OrganizationsServicesServiceQueryEndpoint500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesServiceQueryEndpoint500Error1>.Some(value), default);

    private static InstanceQueryEndpointUpsertError AsFallback(RawError value) =>
    ...
    internal static Task<InstanceQueryEndpointUpsertError> Create(HttpResponseMessage response,
...
internal sealed class InstanceQueryEndpointUpsertErrorResponse : IErrorResponse<InstanceQueryEndpointUpsertError>
{
    public static InstanceQueryEndpointUpsertErrorResponse Instance { get; } = new();

    private InstanceQueryEndpointUpsertErrorResponse()
    {
    }

    public Task<InstanceQueryEndpointUpsertError> Map(HttpResponseMessage response, CancellationToken ct) =>
        InstanceQueryEndpointUpsertError.Create(response, ct);
}
