...
public sealed class InvitationGetError : ApiError
{
    ...
    private InvitationGetError(Optional<V1OrganizationsInvitations400Error1> v1OrganizationsInvitations400Error1Value,
    ...
    private static InvitationGetError AsV1OrganizationsInvitations400Error1(V1OrganizationsInvitations400Error1 value) =>
        new(Optional<V1OrganizationsInvitations400Error1>.Some(value), default, default);

    private static InvitationGetError AsV1OrganizationsInvitations500Error1(V1OrganizationsInvitations500Error1 value) =>
        new(default, Optional<V1OrganizationsInvitations500Error1>.Some(value), default);

    private static InvitationGetError AsFallback(RawError value) =>
    ...
    internal static Task<InvitationGetError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class InvitationGetErrorResponse : IErrorResponse<InvitationGetError>
{
    public static InvitationGetErrorResponse Instance { get; } = new();

    private InvitationGetErrorResponse()
    {
    }

    public Task<InvitationGetError> Map(HttpResponseMessage response, CancellationToken ct) =>
        InvitationGetError.Create(response, ct);
}
