...
public sealed class MemberGetListError : ApiError
{
    ...
    private MemberGetListError(Optional<V1OrganizationsMembers400Error1> v1OrganizationsMembers400Error1Value,
    ...
    private static MemberGetListError AsV1OrganizationsMembers400Error1(V1OrganizationsMembers400Error1 value) =>
        new(Optional<V1OrganizationsMembers400Error1>.Some(value), default, default);

    private static MemberGetListError AsV1OrganizationsMembers500Error1(V1OrganizationsMembers500Error1 value) =>
        new(default, Optional<V1OrganizationsMembers500Error1>.Some(value), default);

    private static MemberGetListError AsFallback(RawError value) =>
    ...
    internal static Task<MemberGetListError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class MemberGetListErrorResponse : IErrorResponse<MemberGetListError>
{
    public static MemberGetListErrorResponse Instance { get; } = new();

    private MemberGetListErrorResponse()
    {
    }

    public Task<MemberGetListError> Map(HttpResponseMessage response, CancellationToken ct) =>
        MemberGetListError.Create(response, ct);
}
