...
public sealed class OrganizationByocInfrastructureCreateError : ApiError
{
    ...
    private OrganizationByocInfrastructureCreateError(Optional<V1OrganizationsByocInfrastructure400Error1> v1OrganizationsByocInfrastructure400Error1Value,
    ...
    private static OrganizationByocInfrastructureCreateError AsV1OrganizationsByocInfrastructure400Error1(V1OrganizationsByocInfrastructure400Error1 value) =>
        new(Optional<V1OrganizationsByocInfrastructure400Error1>.Some(value), default, default);

    private static OrganizationByocInfrastructureCreateError AsV1OrganizationsByocInfrastructure500Error1(V1OrganizationsByocInfrastructure500Error1 value) =>
        new(default, Optional<V1OrganizationsByocInfrastructure500Error1>.Some(value), default);

    private static OrganizationByocInfrastructureCreateError AsFallback(RawError value) =>
    ...
    internal static Task<OrganizationByocInfrastructureCreateError> Create(HttpResponseMessage response,
...
internal sealed class OrganizationByocInfrastructureCreateErrorResponse : IErrorResponse<OrganizationByocInfrastructureCreateError>
{
    public static OrganizationByocInfrastructureCreateErrorResponse Instance { get; } = new();

    private OrganizationByocInfrastructureCreateErrorResponse()
    {
    }

    public Task<OrganizationByocInfrastructureCreateError> Map(HttpResponseMessage response, CancellationToken ct) =>
        OrganizationByocInfrastructureCreateError.Create(response, ct);
}
