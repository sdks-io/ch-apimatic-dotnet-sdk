...
public sealed class OrganizationByocInfrastructureDeleteError : ApiError
{
    ...
    private OrganizationByocInfrastructureDeleteError(Optional<V1OrganizationsByocInfrastructure400Error1> v1OrganizationsByocInfrastructure400Error1Value,
    ...
    private static OrganizationByocInfrastructureDeleteError AsV1OrganizationsByocInfrastructure400Error1(V1OrganizationsByocInfrastructure400Error1 value) =>
        new(Optional<V1OrganizationsByocInfrastructure400Error1>.Some(value), default, default);

    private static OrganizationByocInfrastructureDeleteError AsV1OrganizationsByocInfrastructure500Error1(V1OrganizationsByocInfrastructure500Error1 value) =>
        new(default, Optional<V1OrganizationsByocInfrastructure500Error1>.Some(value), default);

    private static OrganizationByocInfrastructureDeleteError AsFallback(RawError value) =>
    ...
    internal static Task<OrganizationByocInfrastructureDeleteError> Create(HttpResponseMessage response,
...
internal sealed class OrganizationByocInfrastructureDeleteErrorResponse : IErrorResponse<OrganizationByocInfrastructureDeleteError>
{
    public static OrganizationByocInfrastructureDeleteErrorResponse Instance { get; } = new();

    private OrganizationByocInfrastructureDeleteErrorResponse()
    {
    }

    public Task<OrganizationByocInfrastructureDeleteError> Map(HttpResponseMessage response, CancellationToken ct) =>
        OrganizationByocInfrastructureDeleteError.Create(response, ct);
}
