...
public sealed class OrganizationGetError : ApiError
{
    ...
    private OrganizationGetError(Optional<V1Organizations400Error1> v1Organizations400Error1Value,
    ...
    private static OrganizationGetError AsV1Organizations400Error1(V1Organizations400Error1 value) =>
        new(Optional<V1Organizations400Error1>.Some(value), default, default);

    private static OrganizationGetError AsV1Organizations500Error1(V1Organizations500Error1 value) =>
        new(default, Optional<V1Organizations500Error1>.Some(value), default);

    private static OrganizationGetError AsFallback(RawError value) =>
    ...
    internal static Task<OrganizationGetError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class OrganizationGetErrorResponse : IErrorResponse<OrganizationGetError>
{
    public static OrganizationGetErrorResponse Instance { get; } = new();

    private OrganizationGetErrorResponse()
    {
    }

    public Task<OrganizationGetError> Map(HttpResponseMessage response, CancellationToken ct) =>
        OrganizationGetError.Create(response, ct);
}
