...
public sealed class OrganizationQuotaGetError : ApiError
{
    ...
    private OrganizationQuotaGetError(Optional<V1OrganizationsQuotas400Error1> v1OrganizationsQuotas400Error1Value,
    ...
    private static OrganizationQuotaGetError AsV1OrganizationsQuotas400Error1(V1OrganizationsQuotas400Error1 value) =>
        new(Optional<V1OrganizationsQuotas400Error1>.Some(value), default, default);

    private static OrganizationQuotaGetError AsV1OrganizationsQuotas500Error1(V1OrganizationsQuotas500Error1 value) =>
        new(default, Optional<V1OrganizationsQuotas500Error1>.Some(value), default);

    private static OrganizationQuotaGetError AsFallback(RawError value) =>
    ...
    internal static Task<OrganizationQuotaGetError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class OrganizationQuotaGetErrorResponse : IErrorResponse<OrganizationQuotaGetError>
{
    public static OrganizationQuotaGetErrorResponse Instance { get; } = new();

    private OrganizationQuotaGetErrorResponse()
    {
    }

    public Task<OrganizationQuotaGetError> Map(HttpResponseMessage response, CancellationToken ct) =>
        OrganizationQuotaGetError.Create(response, ct);
}
