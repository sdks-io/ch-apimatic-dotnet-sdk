...
public sealed class OrganizationRoleDeleteError : ApiError
{
    ...
    private OrganizationRoleDeleteError(Optional<V1OrganizationsRoles400Error1> v1OrganizationsRoles400Error1Value,
    ...
    private static OrganizationRoleDeleteError AsV1OrganizationsRoles400Error1(V1OrganizationsRoles400Error1 value) =>
        new(Optional<V1OrganizationsRoles400Error1>.Some(value), default, default);

    private static OrganizationRoleDeleteError AsV1OrganizationsRoles500Error1(V1OrganizationsRoles500Error1 value) =>
        new(default, Optional<V1OrganizationsRoles500Error1>.Some(value), default);

    private static OrganizationRoleDeleteError AsFallback(RawError value) =>
    ...
    internal static Task<OrganizationRoleDeleteError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class OrganizationRoleDeleteErrorResponse : IErrorResponse<OrganizationRoleDeleteError>
{
    public static OrganizationRoleDeleteErrorResponse Instance { get; } = new();

    private OrganizationRoleDeleteErrorResponse()
    {
    }

    public Task<OrganizationRoleDeleteError> Map(HttpResponseMessage response, CancellationToken ct) =>
        OrganizationRoleDeleteError.Create(response, ct);
}
