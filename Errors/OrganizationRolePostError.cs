...
public sealed class OrganizationRolePostError : ApiError
{
    ...
    private OrganizationRolePostError(Optional<V1OrganizationsRoles400Error1> v1OrganizationsRoles400Error1Value,
    ...
    private static OrganizationRolePostError AsV1OrganizationsRoles400Error1(V1OrganizationsRoles400Error1 value) =>
        new(Optional<V1OrganizationsRoles400Error1>.Some(value), default, default);

    private static OrganizationRolePostError AsV1OrganizationsRoles500Error1(V1OrganizationsRoles500Error1 value) =>
        new(default, Optional<V1OrganizationsRoles500Error1>.Some(value), default);

    private static OrganizationRolePostError AsFallback(RawError value) =>
    ...
    internal static Task<OrganizationRolePostError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class OrganizationRolePostErrorResponse : IErrorResponse<OrganizationRolePostError>
{
    public static OrganizationRolePostErrorResponse Instance { get; } = new();

    private OrganizationRolePostErrorResponse()
    {
    }

    public Task<OrganizationRolePostError> Map(HttpResponseMessage response, CancellationToken ct) =>
        OrganizationRolePostError.Create(response, ct);
}
