...
public sealed class OrganizationRolesGetListError : ApiError
{
    ...
    private OrganizationRolesGetListError(Optional<V1OrganizationsRoles400Error1> v1OrganizationsRoles400Error1Value,
    ...
    private static OrganizationRolesGetListError AsV1OrganizationsRoles400Error1(V1OrganizationsRoles400Error1 value) =>
        new(Optional<V1OrganizationsRoles400Error1>.Some(value), default, default);

    private static OrganizationRolesGetListError AsV1OrganizationsRoles500Error1(V1OrganizationsRoles500Error1 value) =>
        new(default, Optional<V1OrganizationsRoles500Error1>.Some(value), default);

    private static OrganizationRolesGetListError AsFallback(RawError value) =>
    ...
    internal static Task<OrganizationRolesGetListError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class OrganizationRolesGetListErrorResponse : IErrorResponse<OrganizationRolesGetListError>
{
    public static OrganizationRolesGetListErrorResponse Instance { get; } = new();

    private OrganizationRolesGetListErrorResponse()
    {
    }

    public Task<OrganizationRolesGetListError> Map(HttpResponseMessage response, CancellationToken ct) =>
        OrganizationRolesGetListError.Create(response, ct);
}
