...
public sealed class PostgresServiceCreateError : ApiError
{
    ...
    private PostgresServiceCreateError(Optional<V1OrganizationsPostgres400Error1> v1OrganizationsPostgres400Error1Value,
    ...
    private static PostgresServiceCreateError AsV1OrganizationsPostgres400Error1(V1OrganizationsPostgres400Error1 value) =>
        new(Optional<V1OrganizationsPostgres400Error1>.Some(value), default, default);

    private static PostgresServiceCreateError AsV1OrganizationsPostgres500Error1(V1OrganizationsPostgres500Error1 value) =>
        new(default, Optional<V1OrganizationsPostgres500Error1>.Some(value), default);

    private static PostgresServiceCreateError AsFallback(RawError value) =>
    ...
    internal static Task<PostgresServiceCreateError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class PostgresServiceCreateErrorResponse : IErrorResponse<PostgresServiceCreateError>
{
    public static PostgresServiceCreateErrorResponse Instance { get; } = new();

    private PostgresServiceCreateErrorResponse()
    {
    }

    public Task<PostgresServiceCreateError> Map(HttpResponseMessage response, CancellationToken ct) =>
        PostgresServiceCreateError.Create(response, ct);
}
