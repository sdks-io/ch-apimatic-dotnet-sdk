...
public sealed class UpgradeWindowDeleteError : ApiError
{
    ...
    private UpgradeWindowDeleteError(Optional<V1OrganizationsServicesUpgradeWindow400Error1> v1OrganizationsServicesUpgradeWindow400Error1Value,
    ...
    private static UpgradeWindowDeleteError AsV1OrganizationsServicesUpgradeWindow400Error1(V1OrganizationsServicesUpgradeWindow400Error1 value) =>
        new(Optional<V1OrganizationsServicesUpgradeWindow400Error1>.Some(value), default, default);

    private static UpgradeWindowDeleteError AsV1OrganizationsServicesUpgradeWindow500Error1(V1OrganizationsServicesUpgradeWindow500Error1 value) =>
        new(default, Optional<V1OrganizationsServicesUpgradeWindow500Error1>.Some(value), default);

    private static UpgradeWindowDeleteError AsFallback(RawError value) =>
    ...
    internal static Task<UpgradeWindowDeleteError> Create(HttpResponseMessage response, CancellationToken ct) =>
...
internal sealed class UpgradeWindowDeleteErrorResponse : IErrorResponse<UpgradeWindowDeleteError>
{
    public static UpgradeWindowDeleteErrorResponse Instance { get; } = new();

    private UpgradeWindowDeleteErrorResponse()
    {
    }

    public Task<UpgradeWindowDeleteError> Map(HttpResponseMessage response, CancellationToken ct) =>
        UpgradeWindowDeleteError.Create(response, ct);
}
