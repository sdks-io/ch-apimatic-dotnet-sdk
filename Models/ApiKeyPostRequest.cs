...
public record ApiKeyPostRequest
{
    /// <summary>
    /// Name of the key.
    /// </summary>
    ...
    public State6? State { get; init; }

    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("hashData")]
    public ApiKeyHashData? HashData { get; init; }

    /// <summary>
    /// DEPRECATED. Use <c>assignedRoleIds</c> instead. List of roles assigned to the key. Contains at least 1 element.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
