...
public record ClickPipeMutateMongoDbSource
{
    ...
    public required ClickPipeMongoDbPipeSettings Settings { get; init; }
    ...
    public required IReadOnlyList<ClickPipeMongoDbPipeTableMapping> TableMappings { get; init; }
