...
public record ClickPipePatchMySqlSource
{
    ...
    public ClickPipePatchMySqlPipeSettings? Settings { get; init; }
    ...
    [MinLength(0)]
    public IReadOnlyList<ClickPipeMySqlPipeTableMapping>? TableMappingsToAdd { get; init; }
    ...
    [MinLength(0)]
    public IReadOnlyList<ClickPipePatchMySqlPipeRemoveTableMapping>? TableMappingsToRemove { get; init; }
