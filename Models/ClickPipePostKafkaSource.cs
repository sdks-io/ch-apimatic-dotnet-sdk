...
public record ClickPipePostKafkaSource
{
    /// <summary>
    ...
    public ClickPipeMutateKafkaSchemaRegistry? SchemaRegistry { get; init; }
    ...
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("protobufSchema")]
    [StringLength(1048576, MinimumLength = 1)]
    public string? ProtobufSchema { get; init; }
