...
public record ClickStackAlertResponse
{
    /// <summary>
    ...
    public ClickStackAlertSilenced? Silenced { get; init; }

    /// <summary>
    /// Errors recorded during the most recent alert execution, if any.
    /// </summary>
    [JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingNull)]
    [JsonPropertyName("executionErrors")]
    public IReadOnlyList<ClickStackAlertExecutionError>? ExecutionErrors { get; init; }
