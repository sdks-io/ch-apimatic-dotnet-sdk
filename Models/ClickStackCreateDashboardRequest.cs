...
public record ClickStackCreateDashboardRequest
{
    /// <summary>
    /// Dashboard name.
    /// </summary>
    ...
    public required IReadOnlyList<ClickStackTileInput> Tiles { get; init; }
    ...
    public IReadOnlyList<ClickStackFilterInput>? Filters { get; init; }
