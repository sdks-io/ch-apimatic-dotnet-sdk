// <copyright file="IssuePath.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<IssuePath>),
        new System.Type[] {
            typeof(MStringCase),
    ...
    public abstract class IssuePath
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The IssuePath instance, wrapping the provided string value.
        /// </returns>
        public static IssuePath FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The IssuePath instance, wrapping the provided double value.
        /// </returns>
        public static IssuePath FromPrecision(double precision)
        {
        ...
        private sealed class MStringCase : IssuePath, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class PrecisionCase : IssuePath, ICaseValue<PrecisionCase, double>
        {
            public double Value;
