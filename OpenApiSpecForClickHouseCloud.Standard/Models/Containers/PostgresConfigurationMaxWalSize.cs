// <copyright file="PostgresConfigurationMaxWalSize.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PostgresConfigurationMaxWalSize>),
        new System.Type[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class PostgresConfigurationMaxWalSize
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationMaxWalSize instance, wrapping the provided string value.
        /// </returns>
        public static PostgresConfigurationMaxWalSize FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationMaxWalSize instance, wrapping the provided int value.
        /// </returns>
        public static PostgresConfigurationMaxWalSize FromNumber(int number)
        {
        ...
        private sealed class MStringCase : PostgresConfigurationMaxWalSize, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : PostgresConfigurationMaxWalSize, ICaseValue<NumberCase, int>
        {
            public int Value;
