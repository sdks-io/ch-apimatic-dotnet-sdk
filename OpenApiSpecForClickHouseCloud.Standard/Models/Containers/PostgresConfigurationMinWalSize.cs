// <copyright file="PostgresConfigurationMinWalSize.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PostgresConfigurationMinWalSize>),
        new System.Type[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class PostgresConfigurationMinWalSize
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationMinWalSize instance, wrapping the provided string value.
        /// </returns>
        public static PostgresConfigurationMinWalSize FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationMinWalSize instance, wrapping the provided int value.
        /// </returns>
        public static PostgresConfigurationMinWalSize FromNumber(int number)
        {
        ...
        private sealed class MStringCase : PostgresConfigurationMinWalSize, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : PostgresConfigurationMinWalSize, ICaseValue<NumberCase, int>
        {
            public int Value;
