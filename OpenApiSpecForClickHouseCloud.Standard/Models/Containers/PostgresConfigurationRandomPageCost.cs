// <copyright file="PostgresConfigurationRandomPageCost.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PostgresConfigurationRandomPageCost>),
        new System.Type[] {
            typeof(MStringCase),
    ...
    public abstract class PostgresConfigurationRandomPageCost
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationRandomPageCost instance, wrapping the provided string value.
        /// </returns>
        public static PostgresConfigurationRandomPageCost FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationRandomPageCost instance, wrapping the provided double value.
        /// </returns>
        public static PostgresConfigurationRandomPageCost FromPrecision(double precision)
        {
        ...
        private sealed class MStringCase : PostgresConfigurationRandomPageCost, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class PrecisionCase : PostgresConfigurationRandomPageCost, ICaseValue<PrecisionCase, double>
        {
            public double Value;
