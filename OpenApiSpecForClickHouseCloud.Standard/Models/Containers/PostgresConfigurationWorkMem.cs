// <copyright file="PostgresConfigurationWorkMem.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<PostgresConfigurationWorkMem>),
        new System.Type[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class PostgresConfigurationWorkMem
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationWorkMem instance, wrapping the provided string value.
        /// </returns>
        public static PostgresConfigurationWorkMem FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The PostgresConfigurationWorkMem instance, wrapping the provided int value.
        /// </returns>
        public static PostgresConfigurationWorkMem FromNumber(int number)
        {
        ...
        private sealed class MStringCase : PostgresConfigurationWorkMem, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : PostgresConfigurationWorkMem, ICaseValue<NumberCase, int>
        {
            public int Value;
