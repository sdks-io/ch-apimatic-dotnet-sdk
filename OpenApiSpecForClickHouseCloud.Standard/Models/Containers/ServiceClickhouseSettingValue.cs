// <copyright file="ServiceClickhouseSettingValue.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<ServiceClickhouseSettingValue>),
        new System.Type[] {
            typeof(MStringCase),
            typeof(NumberCase)
        },
    ...
    public abstract class ServiceClickhouseSettingValue
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The ServiceClickhouseSettingValue instance, wrapping the provided string value.
        /// </returns>
        public static ServiceClickhouseSettingValue FromString(string mString)
        {
        ...
        /// </summary>
        /// <returns>
        /// The ServiceClickhouseSettingValue instance, wrapping the provided int value.
        /// </returns>
        public static ServiceClickhouseSettingValue FromNumber(int number)
        {
        ...
        private sealed class MStringCase : ServiceClickhouseSettingValue, ICaseValue<MStringCase, string>
        {
            public string Value;
        ...
        private sealed class NumberCase : ServiceClickhouseSettingValue, ICaseValue<NumberCase, int>
        {
            public int Value;
