// <copyright file="UdfCreateRequest1MemoryLimitMib.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UdfCreateRequest1MemoryLimitMib>),
        new System.Type[] {
            typeof(NumberCase)
        },
        false
    )]
    public abstract class UdfCreateRequest1MemoryLimitMib
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The UdfCreateRequest1MemoryLimitMib instance, wrapping the provided int value.
        /// </returns>
        public static UdfCreateRequest1MemoryLimitMib FromNumber(int number)
        {
        ...
        private sealed class NumberCase : UdfCreateRequest1MemoryLimitMib, ICaseValue<NumberCase, int>
        {
            public int Value;
