// <copyright file="UdfCreateRequestMemoryLimitMib.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UdfCreateRequestMemoryLimitMib>),
        new System.Type[] {
            typeof(NumberCase)
        },
        false
    )]
    public abstract class UdfCreateRequestMemoryLimitMib
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The UdfCreateRequestMemoryLimitMib instance, wrapping the provided int value.
        /// </returns>
        public static UdfCreateRequestMemoryLimitMib FromNumber(int number)
        {
        ...
        private sealed class NumberCase : UdfCreateRequestMemoryLimitMib, ICaseValue<NumberCase, int>
        {
            public int Value;
