// <copyright file="UdfError.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UdfError>),
        new System.Type[] {
            typeof(MStringCase)
        },
        false
    )]
    public abstract class UdfError
    {
        /// <summary>
        /// This is String case.
        /// </summary>
        /// <returns>
        /// The UdfError instance, wrapping the provided string value.
        /// </returns>
        public static UdfError FromString(string mString)
        {
        ...
        private sealed class MStringCase : UdfError, ICaseValue<MStringCase, string>
        {
            public string Value;
