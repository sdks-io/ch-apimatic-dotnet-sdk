// <copyright file="UdfMaxCommandExecutionTime.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UdfMaxCommandExecutionTime>),
        new System.Type[] {
            typeof(NumberCase)
        },
        false
    )]
    public abstract class UdfMaxCommandExecutionTime
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The UdfMaxCommandExecutionTime instance, wrapping the provided int value.
        /// </returns>
        public static UdfMaxCommandExecutionTime FromNumber(int number)
        {
        ...
        private sealed class NumberCase : UdfMaxCommandExecutionTime, ICaseValue<NumberCase, int>
        {
            public int Value;
