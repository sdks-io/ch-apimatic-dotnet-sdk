// <copyright file="UdfMemoryLimitMib.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UdfMemoryLimitMib>),
        new System.Type[] {
            typeof(NumberCase)
        },
        false
    )]
    public abstract class UdfMemoryLimitMib
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The UdfMemoryLimitMib instance, wrapping the provided int value.
        /// </returns>
        public static UdfMemoryLimitMib FromNumber(int number)
        {
        ...
        private sealed class NumberCase : UdfMemoryLimitMib, ICaseValue<NumberCase, int>
        {
            public int Value;
