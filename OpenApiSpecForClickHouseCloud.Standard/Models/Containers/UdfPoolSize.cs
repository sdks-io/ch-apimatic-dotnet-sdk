// <copyright file="UdfPoolSize.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models.Containers
{
    ...
    /// </summary>
    [JsonConverter(
        typeof(UnionTypeConverter<UdfPoolSize>),
        new System.Type[] {
            typeof(NumberCase)
        },
        false
    )]
    public abstract class UdfPoolSize
    {
        /// <summary>
        /// This is Number case.
        /// </summary>
        /// <returns>
        /// The UdfPoolSize instance, wrapping the provided int value.
        /// </returns>
        public static UdfPoolSize FromNumber(int number)
        {
        ...
        private sealed class NumberCase : UdfPoolSize, ICaseValue<NumberCase, int>
        {
            public int Value;
