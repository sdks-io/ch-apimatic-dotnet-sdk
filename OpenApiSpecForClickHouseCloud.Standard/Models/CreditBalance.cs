// <copyright file="CreditBalance.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models
{
    ...
    public class CreditBalance
    {
        ...
        /// <param name="remainingCredits">remainingCredits.</param>
        ...
        public Models.Type21? Type { get; set; }

        /// <summary>
        /// Remaining credits available on this balance, in ClickHouse Credits (CHCs).
        /// </summary>
        [JsonProperty("remainingCredits", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            return $"CreditBalance : ({string.Join(", ", toStringOutput)})";
        }
        ...
        protected void ToString(List<string> toStringOutput)
        {
            ...
            toStringOutput.Add($"RemainingCredits = {(this.RemainingCredits == null ? "null" : this.RemainingCredits.ToString())}");
