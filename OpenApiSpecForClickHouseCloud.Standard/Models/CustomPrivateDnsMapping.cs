// <copyright file="CustomPrivateDnsMapping.cs" company="APIMatic">
...
namespace OpenApiSpecForClickHouseCloud.Standard.Models
{
    ...
    /// </summary>
    public class CustomPrivateDnsMapping
    {
        [JsonExtensionData]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomPrivateDnsMapping"/> class.
        /// </summary>
        public CustomPrivateDnsMapping()
        {
        ...
        /// Initializes a new instance of the <see cref="CustomPrivateDnsMapping"/> class.
        /// </summary>
        /// <param name="privateDnsName">privateDnsName.</param>
        public CustomPrivateDnsMapping(
        ...
        /// </summary>
        [JsonProperty("privateDnsName", NullValueHandling = NullValueHandling.Ignore)]
        ...
        public override string ToString()
        {
            ...
            return $"CustomPrivateDnsMapping : ({string.Join(", ", toStringOutput)})";
        }
        ...
        {
            toStringOutput.Add($"PrivateDnsName = {this.PrivateDnsName ?? "null"}");
