...
| `UseCustomSortingKey` | `bool?` | Optional | Whether to use a custom sorting key. If true, sortingKeys must be provided. If false or omitted, the default sorting key is the MySQL primary key. |
...
ClickPipeMySqlPipeTableMapping clickPipeMySqlPipeTableMapping = new ClickPipeMySqlPipeTableMapping
{
