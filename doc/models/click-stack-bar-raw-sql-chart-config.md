...
| `DisplayType` | `string` | Required, Constant | Display as a stacked-bar time-series chart.<br><br>**Value**: `"stacked_bar"` |
...
ClickStackBarRawSqlChartConfig clickStackBarRawSqlChartConfig = new ClickStackBarRawSqlChartConfig
{
    ConfigType = "sql",
