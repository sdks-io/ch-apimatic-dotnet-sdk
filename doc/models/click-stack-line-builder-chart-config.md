...
|  --- | --- | --- | --- |
| `DisplayType` | `string` | Required, Constant | Display type discriminator. Must be "line" for line charts.<br><br>**Value**: `"line"` |
...
| `GroupBy` | `string` | Optional | Field expression to group results by (creates separate lines per group value). |
...
ClickStackLineBuilderChartConfig clickStackLineBuilderChartConfig = new ClickStackLineBuilderChartConfig
{
    DisplayType = "line",
