...
# Click Stack Pie Raw Sql Chart Config
...
| `DisplayType` | `string` | Required, Constant | Display as a pie chart.<br><br>**Value**: `"pie"` |
...
ClickStackPieRawSqlChartConfig clickStackPieRawSqlChartConfig = new ClickStackPieRawSqlChartConfig
{
    ConfigType = "sql",
