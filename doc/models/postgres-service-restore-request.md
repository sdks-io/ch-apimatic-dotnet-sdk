...
# Postgres Service Restore Request
...
| `RestoreTarget` | `DateTime` | Required | The point in time at which to recover, as either date/time, named restore point, or a specific transaction ID. |
...
PostgresServiceRestoreRequest postgresServiceRestoreRequest = new PostgresServiceRestoreRequest
{
    Name = "name0",
    RestoreTarget = DateTime.ParseExact("2026-03-31T18:17:37Z", "yyyy'-'MM'-'dd'T'HH':'mm':'ss.FFFFFFFK",
