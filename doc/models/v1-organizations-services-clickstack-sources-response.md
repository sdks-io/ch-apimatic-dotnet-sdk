...
| `Result` | [`List<ClickStackSource>`](../../doc/models/containers/click-stack-source.md) | Optional | - |
...
V1OrganizationsServicesClickstackSourcesResponse v1OrganizationsServicesClickstackSourcesResponse = new V1OrganizationsServicesClickstackSourcesResponse
{
    Status = 200,
    RequestId = new Guid("00000726-0000-0000-0000-000000000000"),
    Result = new List<ClickStackSource>
    {
        ClickStackSource.FromClickStackLogSource(
