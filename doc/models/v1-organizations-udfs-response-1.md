...
# V1 Organizations Udfs Response 1
...
| `Result` | [`UdfListResponse`](../../doc/models/udf-list-response.md) | Required | - |
...
V1OrganizationsUdfsResponse1 v1OrganizationsUdfsResponse1 = new V1OrganizationsUdfsResponse1
{
    Status = 200,
    RequestId = new Guid("00000a84-0000-0000-0000-000000000000"),
    Result = new UdfListResponse
    {
        Items = new List<Udf>
        {
            new Udf
